...
from gridsearch_snapshots_lad_common import (
    CPSample,
    compute_and_store_signals_for_n_eigen,
    compute_laplacian_signatures,
    compute_similarity_signal_from_signatures,
    detect_change_points_from_signal,
    evaluate_precomputed_n_eigen_signals,
    get_signal_result_filename,
    grid_search_lad,
    laplacian_spectrum_similarity,
    resolve_second_window_length,
    save_signal_result,
)
...
grid_search_laplacian_similarity = grid_search_lad
