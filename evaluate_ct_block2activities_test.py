...
def main() -> None:
    parser = build_ct_test_evaluation_parser(
        default_training_results_path="gridsearch_results/ct_block2activities/gridsearch_results.pkl",
        default_test_dataset_path="data/ct_block2activities_test.pkl",
        default_outdir="gridsearch_results/ct_block2activities",
        description="Evaluate the best continuous-time entropy model on the ct_block2activities test set.",
    )
